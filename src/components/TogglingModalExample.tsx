...
export const TogglingModalExample = () => {
  const [state, send] = useMachine(togglingModalMachine, { devTools: true });
  return (
    <>
      <div className="flex justify-center items-center flex-col gap-4">
        <p className="mt-1 text-2xl tracking-tight font-bold text-gray-900">
          Simple modal open / close toggling
        </p>
        <button
      ...
      <Transition.Root show={state.matches('modal_opened')} as={Fragment}>
        <Dialog
          as="div"
